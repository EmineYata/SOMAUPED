      ...
      sessions: [
        { time: '08h00 - 09h00', title: 'ACCUEIL ET INSCRIPTION', rooms: [] },
        {
          ...
          rooms: [
            ...
            { name: 'Salle 3 - ATELIER 1', moderators: '', sessions: ['Aérosolthérapie'] },
          ],
        },
        { time: '10h30 - 11h00', title: 'PAUSE CAFÉ', rooms: [] },
        {
          ...
          rooms: [
            ...
            },
            {
              ...
              sessions: ['Simulation/Urgences pédiatrie', "Importance du diagnostic précoce en Oncologie - L Hsissen (Maroc)"],
            },
          ],
        },
        {
      ...
      sessions: [
        {
          ...
          rooms: [
            { name: 'Salle 1 - CO3', moderators: 'M Sidatt, W Messadi, S Hamnouda', sessions: ['9 Communications : 8 min + 2 min de discussion'] },
            { name: 'Salle 2 - CO4', moderators: 'E B Zein, A Oulmaati, O Bouyahya', sessions: ['9 Communications : 8 min + 2 min de discussion'] },
            { name: 'Salle 3 - ATELIER 3', moderators: 'O Benrabah, M Mokhtari, A Feil, H Rabani', sessions: ['Réa néo en salle de naissance', '2 ateliers : 1 pour les médecins et 1 pour les sages femmes'] },
          ],
        },
        {
          time: '09h30 - 11h00',
          ...
          rooms: [
            ...
            { name: 'Salle 3 - ATELIER 4', moderators: 'O Bouyahya (Tunisie), A Megueya (Mauritanie)', sessions: ["Cholestases de l'enfant : Pas à Pas"] },
          ],
        },
          ...
          rooms: [
            {
              ...
              sessions: ['Retard de croissance', 'Urgences endocriniennes néonatales - A Linglart (France)', 'Les mucopolysaccharidoses - N Dini (Maroc)'],
            },
            {
              name: 'Salle 2 - GASTRO-ENTÉROLOGIE-NUTRITION',
              moderators: 'O Bouyahya, D Benlahcene, R Belbouab, A Kane',
              sessions: ['Diversification alimentaire, Allergie aux PLV - P Tounian (France)', "Les œsophagites à éosinophiles - N Siala (Tunisie)", 'CAT devant une élévation des transaminases - O Bouyahya', 'Les gastrites à HP - L Beddi (Mauritanie)'],
            },
            { name: 'Salle 3', moderators: '', sessions: [] },
          ],
        },
        { time: '13h00 - 15h00', title: 'PAUSE-DÉJEUNER (ET PRIÈRE)', rooms: [] },
        {
          ...
          title: 'SYMPOSIUM',
          rooms: [
            { name: 'Salle 1 - BIOMERIEUX', moderators: 'M Bouskraoui', sessions: ["Impact de l'approche syndromique (PCR FilmArray) sur le diagnostic rapide"] },
            { name: 'Salle 2 - LABORATOIRE NESTLE', moderators: 'A Feil', sessions: ['Probiotiques et HMO - I Khalifa (Mauritanie)'] },
          ],
        },
        {
          time: '16h00 - 17h30',
      ...
      sessions: [
        {
          ...
          title: 'COMMUNICATIONS ORALES',
          rooms: [
            { name: 'Salle 1 - CO5', moderators: 'M Bezeid, L Haddad, S Mabrouk', sessions: ['9 Communications : 8 min + 2 min de discussion'] },
            { name: 'Salle 2 - CO6', moderators: 'K Mekhalle, Z Fitouri, K Haddad', sessions: ['9 Communications : 8 min + 2 min de discussion'] },
            { name: 'Salle 3 - ATELIER 5', moderators: '', sessions: ['Rattrapage vaccinal'] },
          ],
        },
        {
          time: '09h30 - 11h00',
          ...
          rooms: [
            ...
            { name: 'Salle 3 - ATELIER 6', moderators: 'H Afilal (Maroc), N E Abdellahi (Mauritanie)', sessions: ['Les chocs hémodynamiques pour les nuls'] },
          ],
        },
        { time: '11h00 - 11h30', title: 'PAUSE CAFÉ', rooms: [] },
        {
          ...
          rooms: [
            ...
            { name: 'Salle 3 - ATELIER 7', moderators: 'M Elkhorassani, L Hsissen, E Zein', sessions: ["Hémophilie/Oncopédiatrie"] },
          ],
        },
        { time: '13h00 - 14h30', title: 'PAUSE-DÉJEUNER', rooms: [] },
        {
          ...
          title: 'SYMPOSIUM',
          rooms: [
            { name: 'Salle 1 - FONDATION CHIESI', moderators: 'O Ndiaye', sessions: ['Fondation Paolo Chiesi : Innover et agir pour la santé périnatale', 'Modèle NEST - F Cassera, F Bianco, O Mouhamadou, A Dogo'] },
            { name: 'Salle 2 - LABORATOIRE FRANCE LAIT', moderators: 'M Telmoudi', sessions: ['Prise en charge des troubles digestifs fonctionnels du nourrisson - I Khalifa'] },
          ],
        },
        {
          time: '15h30 - 17h00',
          ...
          rooms: [
            {
              ...
              sessions: ['Entérocolites - M Mokhtari (Maroc)', "Membranes hyalines - O N'Diaye (Sénégal)", 'Alimentation du prématuré - M Mokhtari (Maroc)'],
            },
            {
              name: 'Salle 2 - SESSION URGENCES/RÉANIMATION',
              moderators: 'K Menif, M Sidatt, L Karboubi, A Ndiaye',
              sessions: ['Prise en charge du choc septique de l\'enfant - K Menif (Tunisie)', 'Intoxications - L Karboubi (Maroc)', "Prise en charge d'un état de mal convulsif - F Thabet (Tunisie)"],
            },
            { name: 'Salle 3 - ATELIER 8', moderators: 'L Haddad (Algérie), M Hamdy (Mauritanie)', sessions: ["ECG de l'enfant"] },
          ],
        },
        { time: '17h00 - 17h30', title: 'PAUSE CAFÉ', rooms: [] },
        {
          ...
          rooms: [
            {
              ...
              sessions: ['Coqueluche - R Boukari (Algerie)', 'HPV, VRS - T Sfar (Tunisie), H Haas (France)', 'Vaccinations complémentaires (HVA, Meningo, Varicelle, grippe) - M Bouskraoui'],
            },
            {
                    ...
                    {session.rooms.map((room: any, idx: number) => (
                      <div key={idx} className="room-card">
                        ...
                        <ul className="room-sessions">
                          {room.sessions.map((s: string, i: number) => (
                            <li key={i}>{s}</li>
                          ))}
                        </ul>
                      </div>
